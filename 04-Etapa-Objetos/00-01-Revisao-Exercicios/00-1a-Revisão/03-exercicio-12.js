...
const generateMovieMessage = ({ title, directedBy }) => {
  message += `
...
// Mesma coisa da linha 71
const youtuberVideos = youtubeUser.videos.recentVideos;

const { videos: { recentVideos } } = youtubeUser;

// recentVideos.forEach(({ title }) => {
//   console.log(`${title}`);
// })
