...
const animals = ['leão', 'tucano', 'elefante', 'pavão', 'hipopótamo', 'leão'];
let warnMessage = null;

for (let index = 0; index < animals.length; index += 1) {
  const dontExistsLion = !animals[index].includes('leão');

  if (dontExistsLion) {
    warnMessage = 'Leão não existe no aray animals.';
    break;
  } else {
    warnMessage = 'Existe um leão no array animals.';
    break;
  }
}
...
let sumOfRandomNumbers = null;

// for (let index = 0; index < randomNumbers.length; index += 1) {
//   sumOfRandomNumbers += randomNumbers[index];

//   if (sumOfRandomNumbers > 400) {
//     console.log(`A soma ultrapassou 400. Até aqui, o valor atual ${sumOfRandomNumbers}.`);
//     break;
//   }
// }
...
const fourStrings = stringItems.join(', ').replace(`, ${lastItem}`, ` e ${lastItem}`);
...
/*
  ...
  - Se o tipo da bebida é água, atribua à uma variável a mensagem "Substância química cujas moléculas são formadas por dois átomos de hidrogênio e um de oxigênio.";
