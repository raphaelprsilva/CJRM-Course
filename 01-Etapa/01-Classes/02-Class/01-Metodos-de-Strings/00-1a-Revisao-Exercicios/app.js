...
const js = (programmingLanguage[programmingLanguage.indexOf('J')] + programmingLanguage[programmingLanguage.indexOf('S')]).toLowerCase();
...
const mdn = (mozilla[mozilla.indexOf('M')] + mozilla[mozilla.indexOf('D')] + mozilla[mozilla.indexOf('N')]).toLowerCase();
...
const lastIndexPosition = randomWord.length - 1;
const lastWord = randomWord[lastIndexPosition];
...
const summerMessageInLowerCase = summerMessage.toLowerCase();

// console.log(summerMessageInLowerCase);
...
const winterMessageInUpperCase = winterMessage.toUpperCase();

// console.log(winterMessageInUpperCase);
...
let newName = name[0].toUpperCase() + name.slice(1, 6) + name.slice(6, 8).toUpperCase() + name.slice(8);
...
newName = `${name[0].toUpperCase()}${name.slice(1, 6)} ${name.slice(6,8).toUpperCase()}${name.slice(8)}`;
