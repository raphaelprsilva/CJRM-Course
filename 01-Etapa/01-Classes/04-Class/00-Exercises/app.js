...
const my3FavoriteTVShows = ['Breaking Bad', 'Prision Break', 'Game of Thrones'];
...
const stringConverted = String(typeSentence.length);

const toCheck = 39;

const message = `A string que a "typeSentence" armazena tem mais de ${toCheck} caracteres? ${String(typeSentence.length > toCheck).replace('t' , 'T')}.`;
...
const myMessage = `Todos os ${falsyValues.length} itens do array "falsyValues" são falsy. Inclusive o  
${falsyValues[2]}.`;
...
// O console.log de crazyConversion resulta em true,
// pois null somado a um número, é do tipo numérico,
// e quando é feita a conversão explícita de um number,
// em Boolean, temos como resultado, um truthy
...
const phrase = `A soma entre o 1º e o 3º item de "ages" é menor ou igual a 92. Essa afirmação  
é: ${ageSum <= 92}.`;
