...
const uncleBenMessage = 'Grandes poderes trazem grandes responsabilidades.';
// console.log(uncleBenMessage);
...
const myFavoriteTom = `Nome: ${tom} ${firstTom}`;
...
const splitedLetterJ = programmingLanguage.slice(0, 1);
const splitedLetterS = programmingLanguage.slice(4, 5);
// console.log(`${splitedLetterJ}${splitedLetterS}`);
