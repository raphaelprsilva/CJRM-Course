...
const firstItemRemoved = crazyArray.shift();
...
const zequinhaObject = dogs.find(({ name }) => name === 'Zequinha');

// console.log(zequinhaObject);
...
const allH2Elements = document.querySelectorAll('.secondary-title');

const logElement = (element) => console.log(element);

// allH2Elements.forEach(logElement);